...
data train;
set train;
format target_flag target.;
target_flag_=input(target_flag,best.);
drop target_flag;
rename target_flag_ =target_flag;run;
data test;
set test;
format target_flag target.;
target_flag_=input(target_flag,best.);
...
rename target_flag_ =target_flag;run;
*corr counting;
proc corr data=train out=train_corr;
with target_flag;run;